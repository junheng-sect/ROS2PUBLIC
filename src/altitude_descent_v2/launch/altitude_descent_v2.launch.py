...
def generate_launch_description():
    ...
    touchdown_range_offset = LaunchConfiguration('touchdown_range_offset')
    terminal_switch_height = LaunchConfiguration('terminal_switch_height')
    ...
    shared_params = {
        ...
        'touchdown_range_offset': touchdown_range_offset,
        'terminal_switch_height': terminal_switch_height,
    ...
    controller_node = Node(
        package='altitude_descent_v2',
        executable='altitude_descent_v2_node',
        name='altitude_descent_v2_node',
        output='screen',
    ...
    csv_logger_node = Node(
        package='altitude_descent_v2',
        executable='altitude_descent_v2_csv_logger_node',
        name='altitude_descent_v2_csv_logger_node',
        output='screen',
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'status_topic',
            default_value='/altitude_descent_v2/status',
        ),
        DeclareLaunchArgument(
            'esc_status_topic',
        ...
        DeclareLaunchArgument('touchdown_range_offset', default_value='0.18'),
        DeclareLaunchArgument('terminal_switch_height', default_value='0.20'),
        ...
        DeclareLaunchArgument(
            'csv_prefix',
            default_value='altitude_descent_v2',
        ),
