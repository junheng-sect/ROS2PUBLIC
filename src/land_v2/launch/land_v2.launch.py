...
def generate_launch_description():
    ...
    align_yaw_tolerance_rad = LaunchConfiguration('align_yaw_tolerance_rad')
    align_yaw_mean_tolerance_rad = LaunchConfiguration(
    ...
    controller_node = Node(
        ...
        parameters=[{
            ...
            'align_yaw_tolerance_rad': align_yaw_tolerance_rad,
            'align_yaw_mean_tolerance_rad': align_yaw_mean_tolerance_rad,
    ...
    csv_logger_node = Node(
        package='land_v2',
        executable='land_v2_csv_logger_node',
        name='land_v2_csv_logger_node',
        output='screen',
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('csv_prefix', default_value='land_v2'),
        ...
        DeclareLaunchArgument(
            ...
            default_value=os.path.expanduser(
                '~/project/rasip_pi_ws/log/tracking_csv/land_v2_summary.csv'
            ),
        ),
        ...
        DeclareLaunchArgument('status_topic', default_value='/land_v2/status'),
        ...
        DeclareLaunchArgument('align_yaw_tolerance_rad', default_value='0.12'),
        DeclareLaunchArgument('align_yaw_mean_tolerance_rad', default_value='0.08'),
        ...
        DeclareLaunchArgument('vz_limit', default_value='0.2'),
