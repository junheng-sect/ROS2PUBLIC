...
默认相机话题参数为 `ros_image_topic:=/camera/image_raw`。
...
- 单次 CSV 目录默认：`/home/zjh/project/zjh_ws/log/tracking_csv`
- 单次 CSV 前缀默认：`pid_tuning`
- 汇总 CSV 默认：`/home/zjh/project/zjh_ws/log/tracking_csv/pid_tuning_summary.csv`
