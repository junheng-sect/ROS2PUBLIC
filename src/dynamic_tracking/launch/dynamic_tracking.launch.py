...
def generate_launch_description():
    ...
    ff_gain_x = LaunchConfiguration('ff_gain_x')
    ff_gain_y = LaunchConfiguration('ff_gain_y')
    ff_filter_alpha = LaunchConfiguration('ff_filter_alpha')
    ff_timeout_sec = LaunchConfiguration('ff_timeout_sec')
    ...
    dynamic_tracking_node = Node(
        package='dynamic_tracking',
        executable='dynamic_tracking_node',
        name='dynamic_tracking_node',
        output='screen',
        parameters=[{
            ...
            'enable_velocity_ff': enable_velocity_ff,
            'ff_gain_x': ff_gain_x,
            'ff_gain_y': ff_gain_y,
            'ff_filter_alpha': ff_filter_alpha,
            'ff_timeout_sec': ff_timeout_sec,
        }],
    )
    ...
    csv_logger_node = Node(
        ...
        name='dynamic_tracking_csv_logger_node',
        output='screen',
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('csv_prefix', default_value='dynamic_tracking'),
        DeclareLaunchArgument('csv_sample_rate_hz', default_value='30.0'),
        DeclareLaunchArgument(
            'summary_csv_path',
            default_value=os.path.expanduser('~/project/rasip_pi_ws/log/tracking_csv/dynamic_tracking_summary.csv'),
        ),
        ...
        DeclareLaunchArgument('enable_velocity_ff', default_value='true'),
        DeclareLaunchArgument('ff_gain_x', default_value='0.4'),
        DeclareLaunchArgument('ff_gain_y', default_value='0.4'),
        DeclareLaunchArgument('ff_filter_alpha', default_value='0.4'),
        DeclareLaunchArgument('ff_timeout_sec', default_value='0.2'),
        tvec_launch,
        tvec_tf_node,
        dynamic_tracking_node,
        csv_logger_node,
    ])
