...
class AltitudeDescentCsvLoggerNode(Node):
    ...
    def __init__(self) -> None:
        super().__init__('altitude_descent_csv_logger_node')
        ...
        self.declare_parameter('file_prefix', 'altitude_descent')
        ...
        self.get_logger().info('altitude_descent_csv_logger_node 已启动')
    ...
    def _on_status(self, msg: String) -> None:
        ...
        try:
            ...
            self.get_logger().warn(f'解析 altitude_descent/status 失败: {exc}')
...
def main(args=None) -> None:
    """启动 altitude_descent_csv_logger_node."""
