...
def generate_launch_description():
    ...
    controller_node = Node(
        package='altitude_hold',
        executable='altitude_hold_node',
    ...
    csv_logger_node = Node(
        package='altitude_hold',
        executable='altitude_hold_csv_logger_node',
        name='altitude_hold_csv_logger_node',
        output='screen',
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'status_topic',
            default_value='/altitude_hold/status',
        ),
        DeclareLaunchArgument(
            'esc_status_topic',
        ...
        DeclareLaunchArgument('csv_prefix', default_value='altitude_hold'),
