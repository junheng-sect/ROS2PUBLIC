...
def _create_csv_logger_node(
    ...
    *,
    ...
    return [
        Node(
            package='dynamic_tracking_v3',
            executable='dynamic_tracking_v3_csv_logger_node',
            name='dynamic_tracking_v3_csv_logger_node',
            output='screen',
            parameters=[{
...
def generate_launch_description():
    ...
    controller_node = Node(
        package='dynamic_tracking_v3',
        executable='dynamic_tracking_v3_node',
        name='dynamic_tracking_v3_node',
        output='screen',
        parameters=[{
            'pose_topic': '/debug/aruco_pose',
            'state_topic': '/mavros/state',
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('csv_prefix', default_value='dynamic_tracking_v3'),
        DeclareLaunchArgument('csv_sample_rate_hz', default_value='30.0'),
        DeclareLaunchArgument(
            'summary_csv_path',
            default_value=os.path.expanduser(
                '~/project/rasip_pi_ws/log/tracking_csv/'
                'dynamic_tracking_v3_summary.csv'
            ),
        ),
        DeclareLaunchArgument(
            'image_raw_timing_topic',
