...
class LandV1CsvLoggerNode(Node):
    """记录 land_v1 运行过程到 CSV，并在退出时写入 summary。"""

    def __init__(self):
        super().__init__('land_v1_csv_logger_node')
        ...
        self.declare_parameter('file_prefix', 'land_v1')
        self.declare_parameter(
            'summary_csv_path',
            '/home/zjh/project/rasip_pi_ws/log/tracking_csv/land_v1_summary.csv',
        )
        ...
        self.get_logger().info(f'land_v1 CSV 记录已启动，输出文件: {self.csv_path}')
